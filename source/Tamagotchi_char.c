...
const Tamagotchi_state_t TAMAGOTCHI_FSM_Moore[12] =
{
        ...
        {SAD,               &tamagotchi_print,{GENERAL,HAPPY  ,GENERAL,GENERAL,ANGRY  ,GENERAL,GENERAL,DYING,       EATING,SLEEPING,FLYING,BATH}},//SAD
        {DISSAPOINTMENT,    &tamagotchi_print,{GENERAL,HAPPY  ,SAD    ,GENERAL,ANGRY  ,GENERAL,GENERAL,DYING,   EATING,SLEEPING,FLYING,BATH}},//DISSAPOINTMENT
        {ANGRY,             &tamagotchi_print,{GENERAL,HAPPY  ,SAD    ,GENERAL,GENERAL,GENERAL,GENERAL,DYING,   EATING,SLEEPING,FLYING,BATH}},//ANGRY
        {NO,                &tamagotchi_print,{GENERAL,HAPPY  ,SAD    ,GENERAL,ANGRY  ,GENERAL,GENERAL,DYING,   EATING,SLEEPING,FLYING,BATH}},//NO
        {MUSIC,             &tamagotchi_print,{GENERAL,HAPPY  ,SAD    ,GENERAL,ANGRY  ,GENERAL,MUSIC,DYING,     EATING,SLEEPING,FLYING,BATH}},//MUSIC
        {DYING,             &tamagotchi_print,{GENERAL,HAPPY  ,SAD    ,GENERAL,ANGRY  ,GENERAL,MUSIC,SAD,       EATING,SLEEPING,FLYING,BATH}},//DYING
        {EATING,            &tamagotchi_print,{GENERAL,HAPPY  ,SAD    ,GENERAL,ANGRY  ,GENERAL,MUSIC,DYING,     EATING,SLEEPING,FLYING,BATH}},//EATING
        {SLEEPING,          &tamagotchi_print,{GENERAL,HAPPY  ,SAD    ,GENERAL,ANGRY  ,GENERAL,MUSIC,DYING,     EATING,SLEEPING,FLYING,BATH}},//SLEEPING
        {FLYING,            &tamagotchi_print,{GENERAL,HAPPY  ,SAD    ,GENERAL,ANGRY  ,GENERAL,MUSIC,DYING,     EATING,SLEEPING,FLYING,BATH}},//FLYING
        {BATH,              &tamagotchi_print,{GENERAL,HAPPY  ,SAD    ,GENERAL,ANGRY  ,GENERAL,MUSIC,DYING,     EATING,SLEEPING,FLYING,BATH}} //BATH
};
